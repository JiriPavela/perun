...
class SystemTapEngine(engine.CollectEngine):
    ...
    def _run_profiled_command(self, config):
        ...
        with utils.nonblocking_subprocess(
            ...
            with HeartbeatThread(HEARTBEAT_INTERVAL, _heartbeat_command, [self.data]):
